...
meta.res <- data.frame(Analysis = "Intrusion Multilevel INTUNSP",
...
meta.res2 <- data.frame(Analysis = "Emotion Multilevel INTUNSP",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res3 <- data.frame(Analysis = "Symtpoms Multilevel INTUNSP",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res4 <- data.frame(Analysis = "Diary Multilevel INTUNSP",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res5 <- data.frame(Analysis = "Questionnaire Multilevel INTUNSP",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res6 <- data.frame(Analysis = "Task Multilevel INTUNSP",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res7 <- data.frame(Analysis = "INTRUSION Multilevel without Outliers INTUNSP",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res8 <- data.frame(Analysis = "EMOTION Multilevel without Outliers INTUNSP",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res9 <- data.frame(Analysis = "SYMPTOMS Multilevel without Outliers INTUNSP",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res10 <- data.frame(Analysis = "DIARY Multilevel without Outliers INTUNSP",
                         n_study = meta$s.nlevels[1],
                         k = meta$s.nlevels[2],
                         Hedgesg = meta$beta,
                         ci.lb = meta$ci.lb,
...
meta.res11 <- data.frame(Analysis = "QUESTIONNAIRE Multilevel without Outliers INTUNSP",
                         n_study = meta$s.nlevels[1],
                         k = meta$s.nlevels[2],
                         Hedgesg = meta$beta,
                         ci.lb = meta$ci.lb,
...
meta.res12 <- data.frame(Analysis = "TASK Multilevel without Outliers INTUNSP",
                         n_study = meta$s.nlevels[1],
                         k = meta$s.nlevels[2],
                         Hedgesg = meta$beta,
                         ci.lb = meta$ci.lb,
...
write.csv(allres, "Results_Multilevel_Meta-Analysis_INTUNSP.csv",row.names = F)