...
IntrusionOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_INTRUSION.csv"
EmotionOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_EMOTION.csv"
SymptomsOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_SYMPTOMS.csv"
DiaryOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_IDIARY.csv"
QuestionnaireOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_IQUESTIONNAIRE.csv"
TaskOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_ITASK.csv"
DPostOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_DPOST.csv"
IDPostOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_I+DPOST.csv"
IPostOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_IPOST.csv"
PeriOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_PERI.csv"
PeriIPostOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_PERI+IPOST.csv"
PreOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_PRE.csv"
PreIPostOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTINC_PRE+IPOST.csv"
