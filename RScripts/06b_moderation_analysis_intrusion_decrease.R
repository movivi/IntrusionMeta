...
write.csv(allTable,"Results_ModeratorAnalysis_INTDEC_INTRUSIONS_ALL_WithoutOutliers.csv",row.names = F)
...
allTable <- sapply(allTable, as.character)
allTable[is.na(allTable)] <- ""
write.csv(allTable,"Results_ModeratorAnalysis_INTDEC_INTRUSIONS_DIARY_WithoutOutliers.csv",row.names = F)
...
#publication status
#df$PublicationStatus = as.factor(df$PublicationStatus)
#a = getTable_Mod1("Moderation: INTDEC PublicationStatus",df$PublicationStatus,2)
#allTable = rbind(allTable,a)
...
allTable <- sapply(allTable, as.character)
allTable[is.na(allTable)] <- ""
write.csv(allTable,"Results_ModeratorAnalysis_INTDEC_INTRUSIONS_TASK_WithoutOutliers.csv",row.names = F)
...
allTable <- sapply(allTable, as.character)
allTable[is.na(allTable)] <- ""
write.csv(allTable,"Results_ModeratorAnalysis_INTDEC_INTRUSIONS_QUESTIONNAIRE_WithoutOutliers.csv",row.names = F)
...
allTable <- sapply(allTable, as.character)
allTable[is.na(allTable)] <- ""
write.csv(allTable,"Results_ModeratorAnalysis_INTDEC_EMOTION_WithoutOutliers.csv",row.names = F)
...
allTable <- sapply(allTable, as.character)
allTable[is.na(allTable)] <- ""
write.csv(allTable,"Results_ModeratorAnalysis_INTDEC_SYMPTOMS_WithoutOutliers.csv",row.names = F)
