...
meta.res <- data.frame(Analysis = "Intrusion Multilevel INTDEC",
...
meta.res2 <- data.frame(Analysis = "Emotion Multilevel INTDEC",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res3 <- data.frame(Analysis = "Symtpoms Multilevel INTDEC",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res4 <- data.frame(Analysis = "Diary Multilevel INTDEC",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res5 <- data.frame(Analysis = "Questionnaire Multilevel INTDEC",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res6 <- data.frame(Analysis = "Task Multilevel INTDEC",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res7 <- data.frame(Analysis = "INTRUSION Multilevel without Outliers INTDEC",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res8 <- data.frame(Analysis = "EMOTION Multilevel without Outliers INTDEC",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res9 <- data.frame(Analysis = "SYMPTOMS Multilevel without Outliers INTDEC",
                        n_study = meta$s.nlevels[1],
                        k = meta$s.nlevels[2],
                        Hedgesg = meta$beta,
                        ci.lb = meta$ci.lb,
...
meta.res10 <- data.frame(Analysis = "DIARY Multilevel without Outliers INTDEC",
                         n_study = meta$s.nlevels[1],
                         k = meta$s.nlevels[2],
                         Hedgesg = meta$beta,
                         ci.lb = meta$ci.lb,
...
meta.res11 <- data.frame(Analysis = "QUESTIONNAIRE Multilevel without Outliers INTDEC",
                         n_study = meta$s.nlevels[1],
                         k = meta$s.nlevels[2],
                         Hedgesg = meta$beta,
                         ci.lb = meta$ci.lb,
...
meta.res12 <- data.frame(Analysis = "TASK Multilevel without Outliers INTDEC",
                         n_study = meta$s.nlevels[1],
                         k = meta$s.nlevels[2],
                         Hedgesg = meta$beta,
                         ci.lb = meta$ci.lb,
...
write.csv(allres, "Results_Multilevel_Meta-Analysis_INTDEC.csv",row.names = F)