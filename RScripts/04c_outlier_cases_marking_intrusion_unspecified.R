...
IntrusionOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_INTRUSION.csv"
EmotionOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_EMOTION.csv"
SymptomsOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_SYMPTOMS.csv"
DiaryOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_IDIARY.csv"
QuestionnaireOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_IQUESTIONNAIRE.csv"
TaskOutFile <- "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_ITASK.csv"
DPostOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_DPOST.csv"
IDPostOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_I+DPOST.csv"
IPostOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_IPOST.csv"
PeriOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_PERI.csv"
PeriIPostOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_PERI+IPOST.csv"
PreOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_PRE.csv"
PreIPostOutFile = "OutlierInfluential/Results_Studentized_Outliers_in_INTUNSP_PRE+IPOST.csv"
