...
write.csv(allTable,"Results_ModeratorAnalysis_INTINC_INTRUSIONS_ALL_WithOutliers.csv",row.names = F)
...
allTable <- sapply(allTable, as.character)
allTable[is.na(allTable)] <- ""
write.csv(allTable,"Results_ModeratorAnalysis_INTINC_INTRUSIONS_DIARY_WithOutliers.csv",row.names = F)
...
allTable <- sapply(allTable, as.character)
allTable[is.na(allTable)] <- ""
write.csv(allTable,"Results_ModeratorAnalysis_INTINC_INTRUSIONS_TASK_WithOutliers.csv",row.names = F)
...
allTable <- sapply(allTable, as.character)
allTable[is.na(allTable)] <- ""
write.csv(allTable,"Results_ModeratorAnalysis_INTINC_INTRUSIONS_QUESTIONNAIRE_WithOutliers.csv",row.names = F)
...
allTable <- sapply(allTable, as.character)
allTable[is.na(allTable)] <- ""
write.csv(allTable,"Results_ModeratorAnalysis_INTINC_EMOTION_WithOutliers.csv",row.names = F)
...
allTable <- sapply(allTable, as.character)
allTable[is.na(allTable)] <- ""
write.csv(allTable,"Results_ModeratorAnalysis_INTINC_SYMPTOMS_WithOutliers.csv",row.names = F)
